...
fitsHeader = Spectra_header("../spectra/spec-10000-57346-0002.fits")
...
fitsNoWeather = Spectra_header("../spectra/spec-4055-55359-0001.fits")
...
badfitsHeader = Spectra_header("junk.fits")
